...
test_that(".upload_file_binary errors when file does not exist", {
  expect_error(
    CyteTypeR:::.upload_file_binary("https://api.example.com", NULL, "obs_duckdb", "/nonexistent/path.duckdb", 60L),
